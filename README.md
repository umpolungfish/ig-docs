...
| `manuscripts3/SYNTESE_FREEZE_NOTE.md` | **Reader note:** submitted freeze pins and where `IG_catalog.json` lives |
...
pipeline are not moved.** See [`manuscripts3/SYNTESE_FREEZE_NOTE.md`](manuscripts3/SYNTESE_FREEZE_NOTE.md).
